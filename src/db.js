export default {
  presentation: {
    product: 'Frontend Task Fundation',
    github:
  ...
  profile: {
    ...
    message:
      'Software Engineer at Frontend Task Fundation in Ciudad falsa, Estado falso',
  },
  skills: [
    {
      id: 1,
  ...
  works: [
    {
      ...
      title: 'Developer',
      years: '2017 - 2018',
      description: 'This is a descripiton',
    },
  ],
  social: [
    {
